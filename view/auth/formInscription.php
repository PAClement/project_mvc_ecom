    ...
    <div class="col-6">
      ...
      <form action="index.php?action=inscription" method="POST">
        <div class="form-group">
          ...
          <input type="email" value="" name="mail" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Password</label>
          <input type="password" value="" name="password" class="form-control" id="exampleInputPassword1" required>
        </div>
